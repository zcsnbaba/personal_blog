...
@section('content')
	...
	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form id="mws-wizard-form" class="mws-form" action="/admin/category/update/{{ $cate['id'] }}" method="post">
                            {{ csrf_field() }}
                            <fieldset id="step-1" class="mws-form-inline">                             
                                <div id class="mws-form-row">
                                    <label class="mws-form-label">分类名称<span class="required">*</span></label>
                                    <div class="mws-form-item">
                                        <input type="text" name="name_class" value="{{ $cate['name_class'] }}" class="required large">
                                    </div>
                                </div>
